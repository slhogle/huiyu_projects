...
This project holds some code snippets for analyzing Huiyu's carbon preference and VOC production and data. It exists to quickly share information, ideas, and code with Huiyu as she analyzes the data and write the manuscripts.
